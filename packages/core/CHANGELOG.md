...
In this update we did some changes so that we could implement the new [`<NodeResizer />`](https://@kiroboio/reactflow.dev/docs/api/nodes/node-resizer/) component more smoothly.
